...
// scrolling library for custom scroll
...
// for scrolling and video animation
// animation starts using function
// function is used like th recursive function 
// gsap animation 
gsap.to("#page>video",{
    scrollTrigger:{
        trigger:`#page>video`,
...
// for oppacity of the image vision pro
gsap.to("#page-bottom",{
    scrollTrigger:{
        trigger:`#page-bottom`,
        start:`5% top`,
...
// feature of gsap is timline
// in timepline only once scrolltrigger is used and then only properties need to be put 
...
scrollTrigger: {
  ...
  //   set start end according to preference
//   start is for when the affect starts 
  start: `top top`,
// end is for when the scroll time for end of the affect
  end: `80% top`,
  scroller: `#main`,
},
onUpdate: render,
